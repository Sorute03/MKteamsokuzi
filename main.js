...
const OVERLAY_GAS_URL = "https://script.google.com/macros/s/AKfycbw9mZJGnCFMgNlBaY8AA8BNKrmxDBeKDHyI622GKpaJn1DEKvBEON4wexP1Q2nM6y_I/exec"; // ← あなたの GAS URL
...
async function sendOverlay(payload) {
  await fetch("https://script.google.com/macros/s/AKfycbw9mZJGnCFMgNlBaY8AA8BNKrmxDBeKDHyI622GKpaJn1DEKvBEON4wexP1Q2nM6y_I/exec", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload),
