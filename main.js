...
const OVERLAY_GAS_URL = "https://script.google.com/macros/s/AKfycbxL13mpCH0rOrkVw_mAi04Ni9RfO5doTvZ5w-JtZOvbfph5WJR0fLjjf09RyBY9wCkk/exec"; // ← あなたの GAS URL
...
async function sendOverlay(payload) {
  await fetch("https://script.google.com/macros/s/AKfycbxL13mpCH0rOrkVw_mAi04Ni9RfO5doTvZ5w-JtZOvbfph5WJR0fLjjf09RyBY9wCkk/exec", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload),
